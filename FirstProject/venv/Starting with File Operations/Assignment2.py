...
#this will look at an individual shhet inside the excel file
print dframe
...
# a list in python
# package lxml needs to be installed before running the below line
...
## Merging Columns##
#many to one merging
dframe3 = DataFrame({'reference': ['hello', 'goodbye', 'please', 'thanks', 'yes'], 'revueue': [1,2,3,4,5]})
